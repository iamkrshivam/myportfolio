...
const Projects = () => {
    const projectsData = [
        ...
        { title:"Network Port Scanner", description:"Fast interactive port scanner — TCP/UDP, auto timeouts, banner/SYN (scapy), JSON/CSV.", tags:["Python","Networking","CyberSecurity","Networking","Port Scanning"]}
    ];
