...
const SocialLinks = () => (
    <div className="hidden md:flex fixed bottom-0 left-8 flex-col items-center space-y-4 z-40">
        {[
            ...
            { href: "https://www.linkedin.com/in/shivamkumar-dce-cybersecurity/", icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg> },
            ].map((social, i) => (
...
const Projects = () => {
    const projectsData = [
        ...
        { title:"Network Port Scanner", description:"Fast interactive port scanner — TCP/UDP, auto timeouts, banner/SYN (scapy), JSON/CSV.", tags:["Python","Networking","CyberSecurity","Networking","Port Scanning"], link:"https://github.com/iamkrshivam/Port_scanner"}
    ];
