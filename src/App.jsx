...
const Projects = () => {
    const projectsData = [
        ...
        { title: "Network Port Scanner", description: "Fast interactive port scanner — TCP/UDP, auto timeouts, banner/SYN (scapy)JSON/CSV.", tags: ["Python", "Cybersecurity", "Networking", "Port Scanning"], link: "https://github.com/iamkrshivam/Port_scanner" }
    ];
